...
void OnTick() {
   ...
   makeTrade(symbol1, pips1);
   makeTrade(symbol2, pips2);
   makeTrade(symbol3, pips3);
   // NZDCAD
}
...
//|                                                                  |
//+------------------------------------------------------------------+
void makeTrade(string symbol, double tpPips) {
   if(symbol == "") {
      return;
   }
