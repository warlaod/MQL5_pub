...
void OnTick() {
  ...
  double Kijun = MathAbs(ciMALong.Main(0) + ciMAMiddle.Main(0))/2;
  ...
  if(isBetween(ciMAMiddle.Main(0),ciMAShort.Main(0),ciMALong.Main(0))) {
    if(myPrice.At(1).low < myPrice.At(0).low && myPrice.At(1).high < myPrice.At(0).high) myTrade.signal = "sell";
  } else if(isBetween(ciMALong.Main(0),ciMAShort.Main(0),ciMAMiddle.Main(0))) {
    if(myPrice.At(1).low > myPrice.At(0).low && myPrice.At(1).high > myPrice.At(0).high) myTrade.signal = "buy";
  }
